...
btsl_east <- st_read(paste0(pathDataJDLT, "CouleesAgricoles/cagFinal_inBTSL.shp"),
                     quiet = T)

#CAG for the BTSL West
btsl_west <- st_read(paste0(pathDataECCC, "CouleesAgricoles/cagFinal.shp"),
                     quiet = T)

#Soil data 
soil <- st_read(paste0(pathDataECCC, "Soils/cag_ProprietesSol.shp"))
